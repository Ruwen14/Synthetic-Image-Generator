...
void clipperTest()
{
	...
	simG::algorithms::translateContour(cntrs2, 0, 3);
	...
	auto poly1 = simG::internals::cvContourToClipperPoly(cntrs1);
	auto poly2 = simG::internals::cvContourToClipperPoly(cntrs2);

	auto area = simG::internals::polyIntersectArea(poly1, poly2);
...
class A //Basis-Klasse
{
public: virtual void Druck() { cout << "Klasse A"; }
	  void Nachricht() { cout << "Nachricht von "; Druck(); }
};
class B : public A //abgeleitete Klasse
{
public: void Druck() override { cout << "Klasse B"; }
};
